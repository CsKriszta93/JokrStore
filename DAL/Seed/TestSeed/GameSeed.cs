        ...
        static void CreateGames(ApplicationDbContext context) {
            List<Game> gameList = new List<Game>
            {
                new Game
                {
                    ...
                    CoverArt = "../_assets/images/games/far_cry_2/CoverArt.png",
                    Rate = 4.0f,
                    Price = 4000,
                    Release = new DateTime(2008, 04, 01),
                    DownloadLink = "../_assets/fary_cry_2.exe",
                    DemoLink = "../_assets/fary_cry_2_demo.exe",
                    NumOfDownloads = 0,
                ...
                new Game
                {
                    ...
                    GameName = "Far Cry",
                    UserId = context.Users.Single(u => u.UserName == "kriszta.csere").Id,
                    CoverArt = "../_assets/images/games/far_cry/CoverArt.png",
                    Rate = 4.0f,
                    Price = 4000,
                    Release = new DateTime(2004, 04, 01),
                    DownloadLink = "../_assets/fary_cry.exe",
                    DemoLink = "../_assets/fary_cry_demo.exe",
                    NumOfDownloads = 0,
                    MinSysReqId = null,
                    RecSysReqId = null,
                    SysReqNotes = "",
                ...
                new Game
                {
                    ...
                    UserId = context.Users.Single(u => u.UserName == "kriszta.csere").Id,
                    CoverArt = "../_assets/images/games/duke_forever/CoverArt.png",
                    Rate = 4.0f,
                    Price = 4000,
                    Release = new DateTime(2011, 04, 01),
                    DownloadLink = "../_assets/duke_forever.exe",
                    DemoLink = "../_assets/duke_forever_demo.exe",
                    NumOfDownloads = 0,
                    MinSysReqId = null,
                    RecSysReqId = null,
                    SysReqNotes = "",
